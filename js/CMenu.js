function CMenu(){
    ...
    this._init = function(){
        ...
        _oButPlay = new CGfxButton((CANVAS_WIDTH/2),CANVAS_HEIGHT -150,oSprite,s_oStage);
        ...
        _pStartPosCredits = {x: (oSprite.width/2) + 10, y: (oSprite.height/2) + 14};            
        ...
        if (_fRequestFullScreen && screenfull.isEnabled){
            ...
            _pStartPosFullscreen = {x:_pStartPosCredits.x + oSprite.width/2 + 12,y:(oSprite.height/2) + 14};
